(function () {
	...
	const captions = [
		'',
		'',
		'<div id="row1"><div class="top-left"><img src="images/monterey/geese.jpeg" alt="geese in a park"></div><div class="top-right"><img src="images/monterey/beach.jpeg" alt="beach in monterey"></div></div><div id="row2"><div class="bottom-left"><img src="images/monterey/seals.jpeg" alt="seals in monterey"></div><div class="bottom-right"><img src="images/monterey/tree.jpg" alt="A tree with flowers"></div>',
		'<div id="row1"><div class="top-left"><img src="images/hmb/muir.jpeg" alt="muir woods"></div><div class="top-right"><img src="images/hmb/castle-rock.jpeg" alt="castle rock state park"></div></div><div id="row2"><div class="bottom-left"><img src="images/hmb/beach.jpeg" alt="half moon bay beach"></div><div class="bottom-right"><img src="images/hmb/sunset.jpeg" alt="half moon bay sunset"></div></div>',
